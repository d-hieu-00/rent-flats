    ...
    <div class="inherit-height card shadow">
        <div class="card-header">
            ...
            <div class="form-check form-switch">
                <input class="form-check-input" type="checkbox" id="lshEnable" v-model="isUsedLshIndex" @change="updateSearchOptions">
                <label class="form-check-label" for="lshEnable">Use Locality Sensitive Hashing Index</label>
            </div>
        </div>
...
export default {
    ...
    methods: {
        ...
        doSearchString() {
            ...
            let type = this.isUsedLshIndex === true ? 2 : 0
            let url = `${location.toString()}api/image?query=${this.searchString}&size=${this.displaySizes.choose}&type=${type}`;
        ...
        uploadImage(file: any) {
            ...
            let type = this.isUsedLshIndex === true ? 2 : 0
            let url = `${location.toString()}api/image/query?size=${this.displaySizes.choose}&type=${type}`;
