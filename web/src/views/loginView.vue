    ...
    <div id="login">
        ...
        <div id="form">
            <form @submit.prevent="doLogin">
                ...
                <input type="text" id="email" v-model="username" placeholder="elon@musk.io" autocomplete="off">
...
export default {
    ...
    data() {
        return {
            username: "",
            password: "",
            passwordFieldIcon: function() { return this.hidePassword ? "fa-eye" : "fa-eye-slash"; },
