...
class GetImgByTextHandler(BaseRequestHandler):
    ...
    def verify_params(self, in_req_path: str):
        ...
        try:
            ...
            if "type" in in_params:
                out_type = int(in_params["type"][0])
        ...
        try:
            ...
            return None
        # Out params
        return (out_first, out_size, out_query, out_type)
    ...
    def _handle(self, req: RequestRouter):
        ...
        # Query from DB
        start_ts = int(time.time() * 1000)
        db_resp = DBHanlder.dbMain.query_img(features, params[0], params[1], params[3])
